<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Archpack.Training.ServiceUnits.Shared.V1.Anonymous.Pages.Login" %>
...
<body>
    <div class="wrap">
        ...
        <div class="main container">
            <form class="form-horizontal" id="mainform" runat="server" aria-autocomplete="none" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="text" id="userName" name="userName" data-prop="userName" runat="server" aria-autocomplete="none" autocomplete="off"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="password" class="col-sm-3 control-label"><%= StringContents.Password %></label>
                    <div class="col-sm-9">
                        <input type="password" class="form-control" id="password" data-prop="password" runat="server" aria-autocomplete="none" autocomplete="off">
                    </div>
                </div>
