<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownloadError.aspx.cs" Inherits="Archpack.Training.ServiceUnits.Shared.V1.Users.Pages.DownloadError" %>
...
<body>
    ...
    <div class="content-wrap container">
        <div class="page-header">
            ...
            <h3 class="error-title-message">ファイルダウンロード時にエラーが発生しました。詳細については下記の情報を参照ください。</h3>
        </div>
